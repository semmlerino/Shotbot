...
def assert_ffmpeg_args_contain(args, expected_flags):
    ...
    for flag in expected_flags:
        assert flag in args_str, f"Expected flag '{flag}' not found in FFmpeg args: {args_str}"
...
def assert_codec_configuration(args, codec_name):
    ...
    assert args[codec_idx] == codec_name, f"Expected codec {codec_name}, got {args[codec_idx]}"