...
def test_apply_and_cache_merge_corruption_falls_back_to_fresh(tmp_path, mocker: MockerFixture):
    ...
    fresh_mock = mocker.MagicMock(spec=Shot)
    ...
    mocker.patch.object(Shot, "from_dict", side_effect=KeyError("bad key"))
